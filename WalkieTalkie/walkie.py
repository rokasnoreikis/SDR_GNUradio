...
class walkie(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "talkie", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "walkie")
        ...
        self._gain_rx_range = Range(0, 60, 1, 10, 200)
        ...
        self._freq_range = Range(400e6, 450e6, 1, 446006250, 200)
        ...
        _Push_push_button = Qt.QPushButton('')
        _Push_push_button = Qt.QPushButton('Push')
        self._Push_choices = {'Pressed': 1, 'Released': 0}
        _Push_push_button.pressed.connect(lambda: self.set_Push(self._Push_choices['Pressed']))
        _Push_push_button.released.connect(lambda: self.set_Push(self._Push_choices['Released']))
        self.top_layout.addWidget(_Push_push_button)
...
def main(top_block_cls=walkie, options=None):
