...
class test_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Test_1", catch_exceptions=True)
        ...
        self.freq = freq = 100.4

        ##################################################
        # Blocks
        ##################################################
        self._gain_rx_range = Range(0, 60, 1, 20, 200)
        ...
        self._freq_range = Range(80, 110, 0.1, 100.4, 200)
